...
// 3. Open the followers page of any account.
// 4. Open the JavaScript console of your browser.
// 5. Copy the code from the script and paste it in the console.
// 6. Press Enter.
// 7. Voila!
    ...
    n.forEach((e) => {
        ...
        o !== r &&
            ...
            (t.innerHTML += `<label class='result-item'>\n            <div class='flex grow align-center'>\n                <img class='avatar' src=${e.profile_pic_url
                } />&nbsp;&nbsp;&nbsp;&nbsp;\n                <div class='flex column'>\n                    <a class='fs-xlarge' target='_blank' href='${e.username
                }'>${e.username}</a>\n                    <span class='fs-medium'>${e.full_name
                }</span>\n                </div>\n                ${e.is_verified
    ...
    for (const i of userIdsToUnfollow) {
        ...
        try {
            await fetch(unfollowUserUrlGenerator(i), {
                ...
                (r.innerHTML += `<div class='p-medium'>Unfollowed\n                <a class='clr-inherit' target='_blank' href='${a.username
                    }'> ${a.username}</a>\n                <span class='clr-cyan'> [${l + 1
                    }/${userIdsToUnfollow.length}]</span>\n            </div>`);
        } catch (e) {
            console.error(e),
                (r.innerHTML += `<div class='p-medium clr-red'>Failed to unfollow ${a.username
